...
import {FaMailBulk, FaServer, FaSitemap} from "react-icons/fa";
      ...
      <div className="container mx-auto max-w-6xl text-gray-600">
        ...
        {showArrow && (
          ...
          <div className="flex justify-center items-end">
              <FaArrowDownLong
                className="text-cyan-600 text-2xl lg:text-3xl font-thin mb-2 animate-moveUpDown absolute bottom-8"/>
            </div>
          </Link>
        )}
